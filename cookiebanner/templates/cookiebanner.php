 ...
 */
?>
<div class="cmplz-cookiebanner cmplz-hidden banner-{id} {consent_type} {position} {use_categories}" data-nosnippet="true" role="dialog" aria-live="polite" aria-labelledby="cmplz-header-{id}-{consent_type}" aria-describedby="cmplz-message-{id}-{consent_type}">
